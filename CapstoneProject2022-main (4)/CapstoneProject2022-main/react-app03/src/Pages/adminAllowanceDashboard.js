...
function AdminAllowanceDashBoard3() {
  ...
  const optionFiller = (path, selectObj) => {
    fetch(`http://localhost:8080/api/csv/${path}/`, {
      method: "GET",
    })
  ...
  useEffect(() => {
    optionFiller("getprojadmin", "project");
    optionFiller("getCategoryadmin", "category");
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    if (pname === "") {
      ...
      if (!(ps === "Invalid Date" && pe === "Invalid Date"))
        fetch(
          `http://localhost:8080/api/csv/getrecordadmin/${pname}/${ps}/${pe}`,
          {
            method: "GET",
          }
        )
        ...
        fetch(`http://localhost:8080/api/csv/getrecordadmin/${pname}`, {
          method: "GET",
        })
          .then((response) => response.json())
          .then((data) => {
    ...
    if (
      ...
      alert(
        "Error in the number of shift days at row number " +
          (index + page * 4 + 1) +
          ". Make sure there are only numbers in the editable fields"
      );
  };
          ...
          >
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (e.target.value === " ")
                  optionFiller(`getprojadmin`, "project");
                else optionFiller(`getprojadmin/${e.target.value}`, "project");
              }}
            >
                  ...
                  <Table sx={{ height: "max-content" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <TableCell>Holiday/Leave days</TableCell>
...
export default AdminAllowanceDashBoard3;
